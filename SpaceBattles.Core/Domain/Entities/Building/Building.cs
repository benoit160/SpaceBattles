    ...
    public static Building[] Buildings()
    {
        ...
        [
            new()
            {
                ...
                Name = "Titanium Mine",
                Description = "Titanium is the primary resource used in the foundation of your Empire. At greater depths, the mines can produce more output of titanium. You can use the available metal for use in the construction of buildings, ships, defense systems, and research. As the mines drill deeper, more energy is required for maximum production. As titanium is the most abundant of all resources available, its value is considered to be the lowest of all resources for trading.",
            ...
            new()
            {
                ...
                Description = "Titanium Storage structures provide huge storage containment for raw unprocessed titanium from metal mines. The higher the level, the more titanium can be held. Once the capacity is used up, no more titanium can be harvested by the metal mines.",
            ...
            new()
            {
                ...
                Description = "Silicon refineries supply the main resource used to produce electronic circuits and form certain alloy compounds. Mining silicon crystals consumes some one and half times more energy than a mining titanium, making crystals more valuable. Almost all ships and all buildings require silicon. Most silicon crystals required to build spaceships, however, are very rare, and like titanium can only be found at a certain depth. Therefore, building mines in deeper strata will increase the amount of silicon produced.",
            ...
            new()
            {
                ...
                Description = "Silicon storage structures provide huge storage containment for unprocessed silicon crystals. The higher the level, the more silicon can be held. Once the capacity is used up, no more silicon can be harvested by the mines.",
            ...
            new()
            {
                ...
                Description = "³Helium is a stable isotope of helium with a natural abundance in the oceans of colonies of approximately one atom in 6500 of helium (~154 PPM). Helium³ thus accounts for approximately 0.015% (on a weight basis, 0.030%) of all water. Helium³ is processed by special synthesizers which can separate the water from the Helium³ using specially designed centrifuges. The upgrade of the synthesizer allows for increasing the amount of Helium³ deposits processed. Helium³ is used when carrying out sensor phalanx scans, viewing galaxies, as fuel for ships, and performing specialized research upgrades.",
            ...
            new()
            {
                ...
                Name = "³Helium storage",
                Description = "³Helium Storage structures provide huge storage containment for ³He from the synthesizer. The higher the level, the more ³He can be held. Once the capacity is used up, no more ³He can be refined by the synthesizer.",
